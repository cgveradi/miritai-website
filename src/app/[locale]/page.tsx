...
export default function Home() {
  ...
  </main><footer className="compact-footer"><div className="wrap"><div className="footer-main"><div><a className="logo" href="#top">MIRIT<span>AI</span></a><p>{t("footerText")}</p></div><a className="button footer-mirit-link" href="https://mirit.org">{t("miritLink")} <span aria-hidden="true">↗</span></a></div><div className="footer-bottom"><span>© 2026 MIRITAI. {t("rights")}</span><span>MIRIT · Research · Culture · Innovation</span></div></div></footer></>;
}
